...
//        helper.add(DEContent.CREATIVE_EXCHANGER,                                "Creative Exchanger");
    ...
    private void guis(PrefixHelper helper) {
        ...
        helper.add("enable_visualization",                                      "Visualization: Disabled");
        helper.add("hide_group_button",                                         "\"New Group\" Button: Shown");
        helper.add("show_group_button",                                         "\"New Group\" Button: Hidden");
        helper.add("hide_delete_zone",                                          "\"Delete Zone\": Shown");
        helper.add("show_delete_zone",                                          "\"Delete Zone\": Hidden");
        helper.add("disable_adv_xover",                                         "Advanced Crossover: Enabled");
        ...
        helper.add("enable_adv_xover",                                          "Advanced Crossover: Disabled");
        ...
        helper.add("preset_applied.msg",                                        "Config preset: \"%s\" Applied to: ");
        helper.add("no_items_for_preset.msg",                                   "[No configurable items found for this preset]");
        ...
        helper.add("setWeather",                                                "Set Weather");
        helper.add("clear",                                                     "Clear Skies");
        helper.add("rain",                                                      "Create Rain");
        helper.add("storm",                                                     "Create Storm");
        helper.add("skipTo",                                                    "Skip To");
        helper.add("sunrise",                                                   "Sunrise");
        helper.add("noon",                                                      "Noon");
    ...
    private void misc(PrefixHelper helper) {
        ...
        add("death.attack." + MODID + ".chaotic_arrow",       "%1$s was shot by %2$s");
